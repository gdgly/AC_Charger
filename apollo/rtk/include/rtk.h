...
/**
 * @brief task event hook for every task.
 *
 * rtk_task_event_default_hook_set: set default hook for task_init.
 * task_event_hook_set: set task hook after task_init.
 */
struct rtk_task;
typedef void (*rtk_task_event_hook_t)(struct rtk_task *task, int event, va_list va );
rtk_task_event_hook_t rtk_task_event_default_hook_set( rtk_task_event_hook_t hook ); /* return last hook */
rtk_task_event_hook_t task_event_hook_set( struct rtk_task *task, rtk_task_event_hook_t hook ); /* return last hook */
...
#define RTK_TASK_EVENT_ON_SEMB_INIT             1
#define RTK_TASK_EVENT_ON_SEMB_TAKE_OK          2
#define RTK_TASK_EVENT_ON_SEMB_TAKE_FAILED      3
#define RTK_TASK_EVENT_ON_SEMB_GIVE_OK          4
#define RTK_TASK_EVENT_ON_SEMB_GIVE_FAILED      5
#define RTK_TASK_EVENT_ON_SEMB_TERMINATE        6
#define RTK_TASK_EVENT_ON_SEMC_INIT             7
#define RTK_TASK_EVENT_ON_SEMC_TAKE_OK          8
#define RTK_TASK_EVENT_ON_SEMC_TAKE_FAILED      9
#define RTK_TASK_EVENT_ON_SEMC_GIVE_OK          10
#define RTK_TASK_EVENT_ON_SEMC_GIVE_FAILED      11
#define RTK_TASK_EVENT_ON_SEMC_TERMINATE        12
#define RTK_TASK_EVENT_ON_SEMC_BROADCAST        13
#define RTK_TASK_EVENT_ON_MUTEX_INIT            14
#define RTK_TASK_EVENT_ON_MUTEX_LOCK_OK         15
#define RTK_TASK_EVENT_ON_MUTEX_LOCK_FAILED     16
#define RTK_TASK_EVENT_ON_MUTEX_UNLOCK_OK       17
#define RTK_TASK_EVENT_ON_MUTEX_UNLOCK_FAILED   18
#define RTK_TASK_EVENT_ON_MUTEX_TERMINATE       19
#define RTK_TASK_EVENT_ON_MSGQ_INIT             20
#define RTK_TASK_EVENT_ON_MSGQ_RX_OK          21
#define RTK_TASK_EVENT_ON_MSGQ_RX_FAILED      22
#define RTK_TASK_EVENT_ON_MSGQ_TX_OK        23
#define RTK_TASK_EVENT_ON_MSGQ_TX_FAILED    24
#define RTK_TASK_EVENT_ON_MSGQ_TERMINATE        25
#define RTK_TASK_EVENT_ON_MSGQ_CLEAR            26
#define RTK_TASK_EVENT_ON_TASK_INIT             27
#define RTK_TASK_EVENT_ON_TASK_START_EXEC       28
#define RTK_TASK_EVENT_ON_TASK_STOP_EXEC        29
#define RTK_TASK_EVENT_ON_TASK_START_READY      30
#define RTK_TASK_EVENT_ON_TASK_STOP_READY       31
#define RTK_TASK_EVENT_ON_PRIORITY_CHANGE		 32
#define RTK_TASK_EVENT_ON_EXIT                  -1          /* task terminated */
		rtk_task_event_hook_t task_event;
