...
/**
 * \file
 * \brief AWBus-lite RTC RX8025 驱动
 *
 * RX8025 是内置 32.768kHZ 数字温度补偿晶体振荡器（DTCXO），以 I2C 总线接口为
 * 通信方式的高精度实时时钟芯片。
...
#ifndef __AWBL_RX8025_H
#define __AWBL_RX8025_H
...
/** \brief RX8025 驱动名 */
#define AWBL_RX8025_NAME   "rx8025"

/**
 * \brief RX8025 设备信息
 */
typedef struct awbl_rx8025_devinfo {
...
} awbl_rx8025_devinfo_t;

/**
 * \brief RX8025 设备实例
 */
typedef struct awbl_rx8025_dev {
...
/**
 * \brief RX8025 driver register
 */
void awbl_rx8025_drv_register (void);

#ifdef __cplusplus
}
#endif  /* __cplusplus  */

#endif  /* __AWBL_RX8025_H */
