...
#define AWBL_IMX28_OCOTP_NAME   "imx28_ocotp"

/**
 * \brief imx283 ocotp 设备信息
 */
struct awbl_imx28_ocotp_devinfo {
...
/**
 * \brief imx283 ocotp 设备实例
 */
struct awbl_imx28_ocotp_dev {
 ...
 */
void awbl_imx28_ocotp_register(void);
