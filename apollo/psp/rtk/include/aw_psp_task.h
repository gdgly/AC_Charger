...
/******************************************************************************/
#define AW_PSP_TASK_SUSPEND(task)    TASK_SUSPEND(task)

/******************************************************************************/
#define AW_PSP_TASK_RESUME(task)    TASK_RESUME(task)

/******************************************************************************/
#define AW_PSP_TASK_VALID(task)       ((task).tcb.status != TASK_DEAD)
